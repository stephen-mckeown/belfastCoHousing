...
export default function BasicTimeline() {
  return (
    <Timeline>
      <TimelineItem>
        <TimelineSeparator>
          <TimelineDot sx={{ backgroundColor: '#b10c0c' }}/>
          <TimelineConnector sx={{ backgroundColor: '#b10c0c' }}/>
        </TimelineSeparator>
        <TimelineContent>
          <Text variant="bold" style={{ color: '#b10c0c' }}>2015</Text>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Text variant="bold" style={{ color: '#b10c0c' }}>2015 - 2019</Text>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Text variant="bold" style={{ color: '#b10c0c' }}>2019</Text>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Text variant="bold" style={{ color: '#b10c0c' }}>2019 - 2021</Text>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Text variant="bold" style={{ color: '#b10c0c' }}>September 2021</Text>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Text variant="bold" style={{ color: '#b10c0c' }}>March 2022</Text>
